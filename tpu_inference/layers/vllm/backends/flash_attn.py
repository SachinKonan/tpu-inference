    ...
    def forward(
        ...
        match self.attn_type:
            ...
            case AttentionType.DECODER:
                ...
                # TODO: hybrid (attention+Mamba) support. Only attention layers
                # live in the unified array today; hybrid models take the legacy
                # per-layer path. When it lands, route Mamba layers to their own
                # kv_caches[1:] slot here.
                attn_flat_indices = vllm_model_wrapper_context.attn_flat_indices
                is_unified = (attn_flat_indices is not None
                              and kv_cache_index in attn_flat_indices)
